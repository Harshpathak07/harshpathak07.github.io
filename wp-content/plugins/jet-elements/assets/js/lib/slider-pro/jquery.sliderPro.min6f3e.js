        ...
        _stopMovement: function() {
            ...
            if ("css-3d" !== this.supportedAnimation && "css-2d" !== this.supportedAnimation || this.isIE !== !1) this.$slides.stop(), this.slidesPosition = parseInt(this.$slides.css("margin-" + this.positionProperty), 10);
                ...
                var b = this.$slides.css(this.vendorPrefix + "transform"),
                    ...
                    e = "matrix3d" === c ? parseInt(d[12], 10) : parseInt(d[5], 10),
            ...
            _stopThumbnailsMovement: function() {
                ...
                if ("css-3d" === this.supportedAnimation || "css-2d" === this.supportedAnimation) {
                    var b = this.$thumbnails.css(this.vendorPrefix + "transform"),
                        ...
                        e = "matrix3d" === c ? parseInt(d[12], 10) : parseInt(d[5], 10),
                        f = "matrix3d" === c ? parseInt(d[13], 10) : parseInt(d[5], 10);
                    "css-3d" === this.supportedAnimation ? a[this.vendorPrefix + "transform"] = "translate3d(" + e + "px, " + f + "px, 0)" : a[this.vendorPrefix + "transform"] = "translate(" + e + "px, " + f + "px)", a[this.vendorPrefix + "transition"] = "", this.$thumbnails.css(a), this.$thumbnails.off(this.transitionEvent), this.thumbnailsPosition = "horizontal" === this.thumbnailsOrientation ? parseInt(d[5], 10) : parseInt(d[5], 10)
        ...
        show: function(a) {
            if (this.visible !== !0) {
                ...
                var b = this,
                    ...
                    d = "undefined" != typeof this.data.showDuration ? this.data.showDuration / 1e3 : .5,
        ...
        hide: function(a) {
            if (this.visible !== !1) {
                var c = this,
                    ...
                    e = "undefined" != typeof this.data.hideDuration ? this.data.hideDuration / 1e3 : .5,
...
function(a) {
    ...
    i.prototype = new d, i.prototype.constructor = i, a.VideoController.addPlayer("HTML5Video", i), i.isType = function(a) {
        ...
        var b = setInterval(function() {
            5 === a.player.readyState && (clearInterval(b), a.ready = !0, a.trigger({
                type: "ready"
